...
This is the 2025-26 edition of the module handbook for NES2303 Experimental Design and Analysis. The handbook contains information about the module, including its aims, learning outcomes, assessment details, and schedule. You can access it via either the HTML or PDF format. If using the HTML format, you can navigate through the handbook using the sidebar on the left. The PDF version is available for download at the bottom of this page.
